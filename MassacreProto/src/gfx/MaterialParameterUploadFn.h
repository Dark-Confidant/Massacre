...
#define MCR_UPLOAD_FN_SPEC(r, data, t)                                  \
    template <>                                                         \
    void uploadParameter<BOOST_PP_TUPLE_ELEM(2, 0, t), false>           \
        (uint program, int loc, const void* mem)                        \
    {                                                                   \
        (void) program;                                                 \
        BOOST_PP_CAT(glUniform, BOOST_PP_TUPLE_ELEM(2, 1, t))(          \
            loc, BOOST_PP_TUPLE_ELEM(2, 2, t)()                         \
            *static_cast<const BOOST_PP_TUPLE_ELEM(2, 0, t)*>(mem));    \
    }
...
#define MCR_UPLOAD_FN_SPEC(r, data, t)                                  \
    template <>                                                         \
    void uploadParameter<BOOST_PP_TUPLE_ELEM(2, 0, t), true>            \
        (uint program, int loc, const void* mem)                        \
    {                                                                   \
        BOOST_PP_CAT(glProgramUniform, BOOST_PP_TUPLE_ELEM(2, 1, t))(   \
            program, loc, BOOST_PP_TUPLE_ELEM(2, 2, t)()                \
            *static_cast<const BOOST_PP_TUPLE_ELEM(2, 0, t)*>(mem));    \
    }
...
#define MCR_UPLOAD_FN_ENTRY_SPEC(r, direct, t) \
    &detail::uploadParameter<BOOST_PP_TUPLE_ELEM(2, 0, t), direct>,
