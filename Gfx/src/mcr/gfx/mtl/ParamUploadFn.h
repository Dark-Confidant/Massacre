...
//////////////////////////////////////////////////////////////////////////
// Parameter type list, must match MaterialParamType::Type
...
void uploadParam(uint program, int loc, const void* mem);
...
#define MCR_UPLOAD_FN_ENTRY_SPEC(r, direct, t) \
    &detail::uploadParam<BOOST_PP_SEQ_ELEM(0, t), direct>,
