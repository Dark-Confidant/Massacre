...
public:
    ...
    MCR_GFX_EXTERN void lookAt(const vec3& target);
    ...
    void                setPerspective();
    MCR_GFX_EXTERN void setFrustum(float left, float right, float bottom, float top);
    ...
    MCR_GFX_EXTERN void dumpMatrices();

    mtl::ParamBuffer*   paramBuffer() const;
...
protected:
    ...
    rcptr<mtl::ParamBuffer> m_paramBuffer;
};
